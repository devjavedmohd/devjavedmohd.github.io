    ...
    return (
        <div className='whatido-bg'>
            <section className="container whatido">
                <h2 className="text-lg pt-12 mb-6 uppercase text-black-600">What I Do</h2>
                    ...
                    <div className="what-i-do">
                        <div className="what-i-do-info">
                            <div className='flex flex-col' data-aos="fade-up" data-aos-offset="10" data-aos-delay="20" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                                <p className='text-2xl pr-3'>I create visually engaging, memorable designs that establish strong connections with your audience. From intuitive user interfaces to seamless user experiences, my designs are crafted to captivate and engage.</p>
                                <div className="what-i-do-info-art mt-8">
                            ...
                            <div className="info-cards-wrapper" data-aos="fade-up" data-aos-offset="10" data-aos-delay="30"
                                ...
                                <div className="info-cards shadow-md">
                                    <div className="info-icon-img py-3">
                ...
                <article className="latest-work border-t border-gray-300 develop">
                    ...
                    <div className="what-i-do">
                        <p className='text-2xl pb-10'>I build digital solutions with scalable architecture, utilizing modern technologies and ensuring top-notch data security. From idea to deployment, I create fast, secure, and responsive products tailored to your needs.</p>
                        <div className="what-i-do-info dev">
                            {/* <div data-aos="fade-up" data-aos-offset="10" data-aos-delay="20" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                                <p className='text-2xl'>I build digital solutions with scalable architecture, utilizing modern technologies and ensuring top-notch data security. From idea to deployment, I create fast, secure, and responsive products tailored to your needs.</p>
                            ...
                            <div className="info-cards-wrapper" data-aos="fade-up" data-aos-offset="10" data-aos-delay="30"
                                data-aos-duration="1500" data-aos-easing="ease-in-out" data-aos-mirror="true"
                                data-aos-once="false">
                                <div className="info-cards border border-gray">
